...
class BaseWorker(ABC):
    ...
    def __init__(self, queue_name: str, worker_id: Optional[str] = None, concurrency: Optional[int] = None):
    ...
    async def initialize(self) -> None:
        ...
        _, self.results_exchange, _ = await self.broker.setup_queue_infrastructure(self.queue_name)
    ...
    async def run(self) -> None:
        ...
        try:
            ...
            self.logger.info(f"Worker {self.worker_id} starting to consume from queue {self.queue_name}")
    ...
    async def cleanup(self) -> None:
        ...
        self.logger.info(f"Worker {self.worker_id} shutdown complete. Processed {self.jobs_processed} jobs.")