...
class FilterWorker(BaseWorker):
    ...
    def __init__(self, queue_name: str, filter_field: str = "content", 
                 filter_value: str = "", worker_id: Optional[str] = None):
    ...
    async def _initialize_processor(self) -> None:
        ...
        self.logger.info(f"Initializing filter processor (field={self.filter_field}, value={self.filter_value})")
