...
class TestBrokerManager:
    ...
    async def test_setup_queue_infrastructure(self, mock_config):
        ...
        # Call the method
        job_queue, results_exchange, dead_letter_queue = await broker.setup_queue_infrastructure("test-queue")
    ...
    @pytest.mark.unit
    async def test_get_queue_stats_via_api_success(self, mock_config, mock_httpx_client):
